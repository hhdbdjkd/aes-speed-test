...
int rijndael_setup_align(const unsigned char *key, int keylen, int num_rounds, symmetric_key *skey);
...
int aes_align(const unsigned char *pt, unsigned char *ct, const symmetric_key *skey);
int aes_detect(const unsigned char *pt, unsigned char *ct, const symmetric_key *skey);
int aes_final(const unsigned char *pt, unsigned char *ct, const symmetric_key *skey);
